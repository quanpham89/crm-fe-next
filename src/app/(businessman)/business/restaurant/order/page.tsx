...
import { handleGetDataOrderDetail, handleGetDataRestaurantById } from "@/utils/action"
...
const DetailOrderRestaurant = async()=>{
    ...
    if(user?.restaurantId){
        dataOrderDetail = await handleGetDataOrderDetail(`api/v1/order-detail/get-data-order-detail?_id=${user?.restaurantId}`, access_token)
