...
const ModalConfirmOrder = (props: any) => {
  const {user, isOpenModalConfirmOrder, setIsOpenModalConfirmOrder, title, data, domainUrl } =
    props;
    ...
    >
      ...
      {currentStep === 2 && data?.paymentForm === "bank" &&
        <div style={{
          ...
          <h2 style={{ textAlign: "center" }}>Quét qr code để thực hiển chuyển khoản.</h2>
          <SVG
          ...
          />
          <Input style={{ display: "none" }} disabled placeholder={`${domainUrl}/customer/cart`} />
      ...
      {currentStep === 3 || currentStep === 2 && data?.paymentForm !== "bank" &&
        <h2 style={{ textAlign: "center", marginTop: 20 }}>Cảm ơn quý khác đã mua hàng.</h2>
      }
