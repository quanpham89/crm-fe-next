  ...
  return <div className="detail-restaurant-container">
    <div className="restaurant">
      ...
      <div className="content">
        <h5 style={{ textAlign: "center", marginBottom: 12, fontSize: 20 }}>{dataRestaurant.restaurantName}</h5>
        <div>
          <div className="truncate"><span className="support-title">Mô tả:  </span> {dataRestaurant.description}</div>
          <div className="truncate"><span className="support-title">Địa chỉ:  </span> {dataRestaurant.address}</div>
