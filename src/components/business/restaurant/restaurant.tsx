...
const RestaurantBusiness = (props: any) => {
  ...
  const [isOpenModalCreateRestaurant, setIsOpenModalCreateRestaurant] =
    useState(false);
    ...
    return isLoading ? (
      ...
      <>
        ...
        {isHaveRestaurant && (
          ...
          >
            <Button onClick={() => setOpenModalConfirmDelete(true)}>
              Xóa tài khoản
            </Button>
            <Button onClick={() => setOpenModalConfirmHidden(true)}>
              Vô hiệu hóa
            </Button>
            <Button onClick={() => setOpenModalConfirmActive(true)}>
              Kích hoạt tài khoản
            </Button>
            <Button onClick={() => setIsOpenUpdateRestaurant(true)}>
              Cập nhập
            </Button>
          </div>
        )}
